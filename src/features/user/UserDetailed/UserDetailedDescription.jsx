...
const UserDetailedDescription = ({ profile }) => {
  ...
  if (profile.createdAt) {
    createdAt = format(profile.createdAt.toDate(), 'd MMM yyyy'); // cant use toDate in rendered jsx will cause error. so we do the toate up here
  }
  return (
      ...
      <Segment>
        <Grid columns={2}>
          <Grid.Column width={10}>
            ...
            <p>
              Originally from <strong>{profile.city || 'tbn'}</strong>
            </p>
            <p>
